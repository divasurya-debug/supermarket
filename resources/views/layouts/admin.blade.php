...
<body class="bg-gray-100 min-h-screen">
  ...
  <!-- Sidebar -->
  <aside id="sidebar"
    class="bg-purple-800 text-white w-64 space-y-2 p-4 fixed inset-y-0 left-0 transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out z-50 h-screen overflow-y-auto">
