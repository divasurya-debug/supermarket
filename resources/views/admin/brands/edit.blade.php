    ...
    <form action="{{ route('admin.brands.update', $brand->id_brands) }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="mb-4">
        ...
        <input type="text" id="nama_merek" name="nama_merek"
               ...
               value="{{ old('nama_merek', $brand->nama_merek) }}" required>
        @error('nama_merek') 
      ...
      <div class="mb-6">
        ...
        {{-- Kalau Cloudinary, cukup langsung pakai URL --}}
        @if($brand->gambar)
      ...
      <div class="flex items-center justify-end">
        ...
        <button type="submit" class="bg-purple-700 text-white font-bold py-2 px-6 rounded-lg">
          Update
        </button>
      </div>
    </form>
