  ...
  <div class="bg-white p-8 rounded-lg shadow-md">
    ...
    <form action="{{ route('admin.brands.store') }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="mb-4">
        ...
        <input type="text" id="nama_merek" name="nama_merek" class="w-full px-4 py-2 border rounded-lg" value="{{ old('nama_merek') }}" required>
      ...
      <div class="mb-4">
        ...
        <input type="text" id="negara_asal" name="negara_asal" class="w-full px-4 py-2 border rounded-lg" value="{{ old('negara_asal') }}">
      </div>
      <div class="mb-6">
